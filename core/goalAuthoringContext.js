...
Legacy acceptance checks support output_contains and file_contains. New evaluation policies use goal/evaluation with typed versioned evaluators, immutable benchmark cases, explicit mandatory gates, named ranking metrics, independent final verification and bounded reference promotion. Only development feedback may guide revisions; never request held-out answers. Never claim runtime verification from static validation. The user's running-loop tool selection is separate from your authoring access.
